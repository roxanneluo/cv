...
\begin{document}
\homepage{bcmi.sjtu.edu.cn/\textasciitilde luoxuan}
...
\cvitemwithcomment{}{Augmented/Virtual Reality}{Volumetric Display}
...
\cvitem{}{Xuejiao Bai, \textbf{Xuan Luo}, Shuo Li.  \textit{\enquote{Adaptive Stereo Matching via Loop-erased Random Walk}.} \textbf{IEEE International Conference on Image Processing (ICIP), 2014}.}
...
\subsection{Volumetric Display}
\cvitem{Advisor}{Steven M. Seitz, University of Washington, US}
\cventry{10.2015-now}{DIY Volumetric Display}{}{}{}{We designed a volumetric display system that are cheap and very easy to duplicate. It only requires a tablet with gyroscope and a rotational symmetric reflector (a plastic cup, a plastic cone made of a piece of plastic sheet, etc.) to show a 3D hologram inside the reflector.}
